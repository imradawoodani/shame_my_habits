# HabitWrapped 🎧
> Spotify Wrapped for your lifestyle habits — track *daily* metrics with lifestyle embeddings, archetypes, and a social circle feed.
...
**Tab 1 — My Hub**
- Log 5 habit metrics via tap counters (enter today's numbers)
- Live balance score + archetype
- "Publish Today" triggers auto-shoutout

**Tab 2 — My Circle**
- Friend circle feed with auto-generated shoutouts
- Daily leaderboard (collapsible)
...
1. Show Hub tab → adjust today's counters → hit "Publish Today"
