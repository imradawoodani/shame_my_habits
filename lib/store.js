...
export function commitDay(log) {
  const history = getHistory();
  history.unshift({ ...log, day: getDayLabel() });
  if (history.length > 30) history.pop(); // keep ~a month of daily entries
  ...
  return [
    {
      ...
      initials: "AK",
      name: "Arjun",
      message: "🔥 Arjun just hit 4 workouts in a day — new personal best. Gym rat era unlocked.",
      time: "2h ago",
    ...
    },
    {
      ...
      initials: "SC",
      name: "Sarah",
      message: "👨‍🍳 Sarah cooked every single meal today. Zero restaurants. Absolutely unhinged.",
      time: "5h ago",
    ...
    },
    {
      ...
      initials: "MR",
      name: "Maya",
      message: "💀 Maya just hit a new eat-out record — 4 times in one day. Insanity.",
      time: "Yesterday",
